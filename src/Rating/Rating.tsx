        ...
        <div className={styles.ratingContent}>
            {!submitSelected ? 
                <div>
                    ...
                    <p className={styles.description}>Please let us know how we did width your support request. All feedback is appreciated to help us improve our offering!</p>
            ...
            : 
                <div className={styles.thanksContainer}>
                    ...
                    <p className={styles.thanksDescription}>We appreciate you taking the time to give a rating. If you ever need more support, don’t hesitate to get in touch!</p>
                </div>
                }
